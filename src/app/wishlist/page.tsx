    ...
    <main className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8 sm:mb-12">
            <div>
                <h1 className="text-3xl sm:text-4xl font-black bg-gradient-to-r from-indigo-400 to-purple-400 bg-clip-text text-transparent">
                    Wishlist
                </h1>
                <p className="text-gray-400 mt-2">Plan your future purchases and track your savings goal.</p>
            </div>
            <div className="flex items-center gap-4 bg-white/5 border border-white/10 rounded-2xl px-4 sm:px-6 py-4">
