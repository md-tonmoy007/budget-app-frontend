...
export default function IncomeFormModal({ isOpen, onClose, onSuccess }: Props) {
    ...
    >
      <div className="bg-[#1a1a1a] border border-white/10 p-8 rounded-2xl w-full max-w-lg shadow-2xl relative">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <h2 className="text-2xl font-bold mb-6">Log Income</h2>
          ...
          <div>
            ...
            <input 
              type="datetime-local" 
              required
              className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-green-500 transition-all"
          ...
          <div>
            ...
            <select 
              required
              className="w-full bg-black/20 border border-white/10 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-green-500 transition-all text-white"
          ...
          <button type="submit" className="w-full bg-green-600 hover:bg-green-700 text-white font-bold py-3 rounded-lg transition-all shadow-lg hover:shadow-green-500/20">
            Log Income
          </button>
        </form>
      </div>
